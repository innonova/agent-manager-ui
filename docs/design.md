...
| `thinking` | shown inline in italic at full contrast, meant to be read: with summarised thinking these are short, curated remarks the CLI would show anyway; only a long one (over ~600 characters) is folded |
